        ...
        <div class="row g-0 vh-100">
            <div class="col-md-6 d-flex align-items-center bg-white p-4 p-lg-5">
                <div class="signup-container mx-auto">
                    <div class="mb-3"> <a class="navbar-brand fw-bold text-dark fs-3" href="indexhtml.php">HEALTH<span class="text-secondary">CARE</span></a>
                    ...
                    <form id="signupForm" class="needs-validation" novalidate autocomplete="off">
                        ...
                        <div class="text-center">
                            <p class="small mb-0">Already have an account? <a href="loginhtml.php?startAnim=1" class="text-dark fw-bold text-decoration-none">Log In</a></p>
                        </div>
                    </form>
                </div>
            </div>
