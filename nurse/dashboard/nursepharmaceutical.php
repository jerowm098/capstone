...
<head>
    ...
    <title>Pharmaceutical Management | PUPBC CareLink</title>
    ...
    <style>
        ...
        /* Updated ID from inventory-frame to pharmaceutical-frame */
        #pharmaceutical-frame {
            width: 100%;
            flex-grow: 1;
            border: none;
...
<body>
    ...
    <div class="floating-form-container">
        <nav class="nav-header-tab">
            <div class="nav-tabs-inline" id="pharmaceuticalTabs">
                <a href="nursepharmaceuticalprescribe.php" data-tab="prescribe" class="nav-link-tab active">
                    <span>Prescribe Medication</span>
                </a>
<!--                 <a href="nursepharmaceuticalavailable.php" data-tab="available" class="nav-link-tab">
                    <span>Available Drugs</span>
                </a>
                <a href="nursepharmaceuticalregister.php" data-tab="register" class="nav-link-tab">
        ...
        <div class="profile-body">
            <iframe src="nursepharmaceuticalprescribe.php" name="pharmaceutical-frame" id="pharmaceutical-frame"></iframe>
        </div>        
    </div>
    ...
    <script>
        ...
        if (window.self === window.top) {
            ...
            const sub = urlParams.get('subpage') || 'nursepharmaceuticalprescribe.php';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const iframe = document.getElementById('pharmaceutical-frame');
            ...
            function switchTab(tabId) {
                const mapping = {
                    'prescribe': 'nursepharmaceuticalprescribe.php',
                    'available': 'nursepharmaceuticalavailable.php',
                    'register': 'nursepharmaceuticalregister.php'
                };

                const iframeSrc = mapping[tabId] || 'nursepharmaceuticalprescribe.php';
            ...
            try {
                if (window.parent !== window.self) {
                    ...
                    if (parentSubpage) {
                        if (parentSubpage.includes('prescribe')) activeSub = 'prescribe';
                        else if (parentSubpage.includes('available')) activeSub = 'available';
                        ...
                        try {
                            if (window.parent !== window.self) {
                                ...
                                const newURL = window.parent.location.origin + window.parent.location.pathname + 
                                               '?page=nursepharmaceutical.php&subpage=' + subFile;
            ...
            iframe.addEventListener('load', function() {
                try {
                    ...
                    if (iframeSrc.includes('prescribe')) activeTabId = 'prescribe';
                    else if (iframeSrc.includes('available')) activeTabId = 'available';
                    ...
                    if (activeTabId) {
                        ...
                        if (window.parent !== window.self) {
                            const newURL = window.parent.location.origin + window.parent.location.pathname + 
                                           '?page=nursepharmaceutical.php&subpage=' + iframeSrc;
                            window.parent.history.replaceState({ path: newURL }, '', newURL);
                        }
                    }
                } catch(e) { }
