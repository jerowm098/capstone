...
<head>
    ...
    <title>Nurse Personnel | PUPBC CareLink</title>
...
<body>
    ...
    <div class="floating-form-container">
        <nav class="nav-header-tab">
            <div class="nav-tabs-inline" id="personnelTabs">
                <a href="nursepersonnelpending.php" data-tab="pending" class="nav-link-tab active">
                    <span>Pending Personnel</span>
                </a>
                <a href="nursepersonnelmanage.php" data-tab="manage" class="nav-link-tab">
        ...
        <div class="profile-body">
            <iframe src="nursepersonnelpending.php" name="personnel-frame" id="personnel-frame"></iframe>
        </div>        
    </div>
    ...
    <script>
        ...
        if (window.self === window.top) {
            ...
            const sub = urlParams.get('subpage') || 'nursepersonnelpending.php';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const iframe = document.getElementById('personnel-frame');
            ...
            function switchTab(tabId) {
                const mapping = {
                    'pending': 'nursepersonnelpending.php',
                    'manage': 'nursepersonnelmanage.php'
                };

                const iframeSrc = mapping[tabId] || 'nursepersonnelpending.php';
                        ...
                        try {
                            if (window.parent !== window.self) {
                                ...
                                const newURL = window.parent.location.origin + window.parent.location.pathname + 
                                               '?page=nursepersonnel.php&subpage=' + subFile;
            ...
            iframe.addEventListener('load', function() {
                try {
                    ...
                    if (activeTabId) {
                        ...
                        if (window.parent !== window.self) {
                            const newURL = window.parent.location.origin + window.parent.location.pathname + 
                                           '?page=nursepersonnel.php&subpage=' + iframeSrc;
                            window.parent.history.replaceState({ path: newURL }, '', newURL);
                        }
                    }
                } catch(e) { }
